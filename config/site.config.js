...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'tvm@office.kollersi.com',
  ...
  footer:
    'Powered by <a href="https://kollersi.com" target="_blank" rel="noopener noreferrer">KOLLERSI.COM</a>. Made with ❤ by Kollersi.',

  // [OPTIONAL] This is where you specify the folders that are password protected. It is an array of paths pointing to all
  // the directories in which you have .password set. Check the documentation for details.
  protectedRoutes: ['/EBOOKS', '/Demo/😎Another Private Folder Password 123'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:kollersi@gmail.com',
